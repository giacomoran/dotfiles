...
#
# Usage (as giacomoran):
#   curl -fsSL https://raw.githubusercontent.com/giacomoran/dotfiles/remote/lerobot-runpod/setup.sh | bash
...
echo ""
echo "For LeRobot:"
echo "  curl -fsSL https://raw.githubusercontent.com/giacomoran/dotfiles/remote/lerobot-runpod/setup-lerobot.sh | bash"
echo ""
